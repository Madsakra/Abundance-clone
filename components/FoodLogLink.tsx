...
import { Modal, View, Text, TouchableOpacity, Image, StyleSheet, Pressable, ImageProps } from 'react-native';
...
export default function FoodLogLink({index,image,routeName}:FoodLogLink) {
  ...
  return (
    <View >
            ...
            <Pressable style={{padding:15,backgroundColor:"#f9f9f9",borderRadius:20}}
            key={index}
